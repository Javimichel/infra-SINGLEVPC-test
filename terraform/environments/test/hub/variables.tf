...
variable "vpc" {
  description = "VPC"
  type        = string
  default = "vpc-028bd2fce7846ae3e"    //SINGLEVPC
}
...
variable "vpc_private_subnets" {
  ...
  type        = list(string)
  default = [ "subnet-0bfcc92e2b4310ade", "subnet-01e19e7cec7fcd8e6", "subnet-0c92b7e6358fc0214", "subnet-0735361d91f146f81" ]
}
...
variable "elb_security_groups" {
  type    = list(string)
  default = ["sg-0d638eab420845652"]     //fury-hub-LoadBalancerSecurityGroup-AAFJIT8E8Q4C
}

variable "instance_security_groups" {
  type    = list(string)
  default = ["sg-03cd520188b24adf2"]     //fury-hub-ServersSecurityGroup-VOWZG4OGQLHD
}
